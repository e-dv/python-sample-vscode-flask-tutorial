[![Build Status](https://dev.azure.com/e-dv/tst01/_apis/build/status%2Fe-dv.python-sample-vscode-flask-tutorial?branchName=main)](https://dev.azure.com/e-dv/tst01/_build/latest?definitionId=1&branchName=main)
